...
Route::post('/payments/webhook/klikqris', [PaymentController::class, 'webhookKlikQris']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/subscription/transactions/{orderId}/status', [PaymentController::class, 'checkTransactionStatus']);
    ...
    Route::post('/stocks/bulk-stock-in', [StockController::class, 'bulkStockIn']);
